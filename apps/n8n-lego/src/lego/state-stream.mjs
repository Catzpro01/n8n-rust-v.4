/**
 * State stream — bounded streaming execution state (P3 Slice E, Issues #75/#97).
 *
 ...
 *   - PERSISTENCE lands in Slice F (snapshot/resume over this exact seam).
 *
 * Purity: ZERO imports — no clock, fs, network, timers, randomness, or
 * process access. One error family `lego.contract_violation`.
 *
