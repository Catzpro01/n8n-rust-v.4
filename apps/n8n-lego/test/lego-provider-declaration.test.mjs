...
test('the lock row is the thirty-second: ai.provider-declaration@1.0.0, owner manager, exports byte-parity', () => {
  ...
  assert.equal(ROWS.length, 36, 'P2.26 added the thirty-second; P3 Slice A adds the thirty-third (workflow.graph); P3 Slice D adds the thirty-fourth (execution.frontier); P3 Slice E adds the thirty-fifth (execution.state-stream); P3 Slice H adds the thirty-sixth (workflow.dna) — count-pins say 36');
