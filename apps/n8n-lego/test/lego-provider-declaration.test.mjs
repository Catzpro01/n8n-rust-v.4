...
test('the lock row is the thirty-second: ai.provider-declaration@1.0.0, owner manager, exports byte-parity', () => {
  ...
  assert.equal(ROWS.length, 34, 'P2.26 added the thirty-second; P3 Slice A adds the thirty-third (workflow.graph); P3 Slice D adds the thirty-fourth (execution.frontier) — count-pins say 34');
