...
test('P9.1 publishes exactly one new contract row without transferring domain ownership', () => {
  ...
  assert.equal(lock.contracts.length, 51); // count-pins say 49 // count-pins say 48 // count-pins say 47 // count-pins say 46 // count-pins say 45 // count-pins say 44 // P9.1=40 + P3 Slice K execution.optimizer=41 + P6.1 node.registry=43
