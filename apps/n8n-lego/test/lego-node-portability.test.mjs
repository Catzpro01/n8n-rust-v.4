...
test('the contract-lock row names real exports, real ops, the real test file — 27 rows total', () => {
  assert.equal(LOCK.contracts.length, 38, 'P2.22 twenty-seventh .. P2.26 thirty-second (ai.provider-declaration), P3 Slice A the thirty-third (workflow.graph), P3 Slice D the thirty-fourth (execution.frontier), P3 Slice E the thirty-fifth (execution.state-stream), P3 Slice H the thirty-sixth (workflow.dna) lock rows; P3 Slice J the thirty-seventh (execution.ir); P3 Slice L the thirty-eighth (compatibility.oracle)');
