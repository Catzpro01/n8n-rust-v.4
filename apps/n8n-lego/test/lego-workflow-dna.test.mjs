...
test('the lock row is the thirty-sixth: workflow.dna@0.1.0, owner agent-1, exports byte-parity', () => {
  ...
  assert.equal(ROWS.length, 40, 'P3 Slice H the thirty-sixth (workflow.dna); P3 Slice J the thirty-seventh (execution.ir); P3 Slice L the thirty-eighth (compatibility.oracle); P3 Slice M the thirty-ninth (execution.guard); P3 Slice K the fortieth (execution.optimizer) — count-pins say 40');
