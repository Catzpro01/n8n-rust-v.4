...
```text
 ...
 2. `P2-S04` in-progress; realtime 100.0%; completion contribution 0.0%; updated 2026-09-26T06:30:00Z
```
...
- **Slice Completion:** **91.4%** (32 / 35 implemented). Remaining 3. 32 implemented, 1 in progress, 2 blocked.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
| `P2-S04` | Dashboard workflow list | Dashboard workflow list (first Layer 3 surface split out of P2-S03) | 🔵 In progress | 100.0% | 0.0% | — | CP-06 Parity equivalent against reference fixtures, fail-closed (completed, 15) | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `76c6a7b49fb502a3`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
