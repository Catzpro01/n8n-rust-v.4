...
P5   realtime ██████████████░░░░░░  72.2%  completion  66.7%  12/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 72.2% | 66.7% | 12/18 | complete |
...
```text
 1. `P5-M07` in-progress; realtime 100.0%; completion contribution 0.0%; updated 2026-09-25T20:23:35Z
...
| `P5-M07` | Service-principal REST + UI management over the P5.7 programmatic lifecycle | Service-principal REST + UI management over the P5.7 programmatic lifecycle (create shown once, redacted list, revoke with tombstone) (split out of P5-M03) | 🔵 In progress | 100.0% | 0.0% | — | CP-06 DEC-0015 required self-hosted runner verification (completed, 10) | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `3c994a131ed62911`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
