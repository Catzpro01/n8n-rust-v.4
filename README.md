...
```text
 1. `P5-M07` planned; realtime 0.0%; completion contribution 0.0%
...
- **Slice Completion:** **66.7%** (12 / 18 implemented). Remaining 6. 12 implemented, 2 planned, 4 blocked.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `9451fc3a6122d1f4`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
