...
Checkpoint-weighted earned points / current-delivery points: 12700 / 14600. Denominator: programs P0–P11 only (146 active slices). Future programs are excluded. 2 slice(s) declare checkpoints. 125 implemented slice(s) have no checkpoint list and contribute 100 each. 19 slice(s) have no checkpoint model and contribute 0. A 0 from a missing model is not a measured fraction of that slice.
...
P5   realtime █████████████░░░░░░░  66.7%  completion  61.1%  11/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 66.7% | 61.1% | 11/18 | complete |
...
```text
 1. `P5-M09` in-progress; realtime 100.0%; completion contribution 0.0%; updated 2026-09-25T19:12:31Z
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `282bff68df64f7f2`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
