...
Checkpoint-weighted earned points / current-delivery points: 12645 / 14600. Denominator: programs P0–P11 only (146 active slices). Future programs are excluded. 2 slice(s) declare checkpoints. 125 implemented slice(s) have no checkpoint list and contribute 100 each. 19 slice(s) have no checkpoint model and contribute 0. A 0 from a missing model is not a measured fraction of that slice.
...
P5   realtime █████████████░░░░░░░  63.6%  completion  61.1%  11/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 63.6% | 61.1% | 11/18 | complete |
...
```text
 1. `P5-M09` in-progress; realtime 45.0%; completion contribution 0.0%; updated 2026-09-25T19:12:14Z
...
- **Realtime Delivery Progress:** **63.6%** `█████████████░░░░░░░ 63.6%`
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `1010026125f977c6`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
