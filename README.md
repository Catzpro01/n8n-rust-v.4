...
Checkpoint-weighted earned points / current-delivery points: 12790 / 14600. Denominator: programs P0–P11 only (146 active slices). Future programs are excluded. 3 slice(s) declare checkpoints. 125 implemented slice(s) have no checkpoint list and contribute 100 each. 18 slice(s) have no checkpoint model and contribute 0. A 0 from a missing model is not a measured fraction of that slice.
...
P5   realtime ██████████████░░░░░░  71.7%  completion  66.7%  12/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 71.7% | 66.7% | 12/18 | complete |
...
```text
 1. `P5-M07` in-progress; realtime 90.0%; completion contribution 0.0%; updated 2026-09-25T20:23:01Z
...
- **Realtime Delivery Progress:** **71.7%** `██████████████░░░░░░ 71.7%`
...
| `P5-M07` | Service-principal REST + UI management over the P5.7 programmatic lifecycle | Service-principal REST + UI management over the P5.7 programmatic lifecycle (create shown once, redacted list, revoke with tombstone) (split out of P5-M03) | 🔵 In progress | 90.0% | 0.0% | — | CP-05 End-to-end proof through the real server plus contract and manifest registration (completed, 15) | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `73b5c48ebeb8f2ff`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
