...
- **Freshness:** generated by `npm run lego:ai` from register 2.1.0 (fingerprint `cd9a0e758afc54f7`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
...
- **Historical P2 ladder:** 17 completed milestones (`P2.11` … `P2.27`, with the `P2.27.x` sub-slices under program P2) are immutable implementation history. Historical pointers: current `P2.27`, previous completed `P2.26` (history, not active work). The generic `P2.17+` (planned) row is a historical placeholder label; it authorizes no work.
...
| --- | --- | --- | --- |
| `P5-M03` | Public /api/v1 first surface | #291 | `cf52701c` |
| `P5-M01` | Security hardening | #289 | `27191091` |
| `FUTURE-RELIABILITY-S01` | Standalone benchmark / reproducibility certification tooling | #246 | `aba5a0e4` |
| `P2-S01` | Frontend LEGO migration foundation + parity harness + status-region pilot | #244 | `c77c3dba` |

### P5 maintenance ladder

| Slice | Title | Status | PR | Merge |
| --- | --- | --- | --- | --- |
| `P5-M01` | Security hardening | implemented | #289 | `27191091` |
| `P5-M02` | Credential runtime integration | blocked | — | — |
| `P5-M03` | Public /api/v1 first surface | implemented | #291 | `cf52701c` |
| `P5-M04` | Key-rotation work list without an O(n) scan | planned | — | — |
| `P5-M05` | Multi-host key storage and shared session + rate-limiter state | blocked | — | — |
| `P5-M06` | Email-based password recovery | blocked | — | — |
| `P5-M07` | Service-principal REST + UI management over the P5.7 programmatic lifecycle | planned | — | — |
| `P5-M08` | Public /api/v1 second surface | in-progress (verifying) | #304 | `600a2145` |
| `P5-M09` | Public /api/v1 credentials | planned | — | — |
| `P5-M10` | Public /api/v1 resources that need a backing model this product does not have yet | blocked | — | — |
...
| --- | --- | --- |
| FUTURE-EVENT | P12 | 0/1 |
| FUTURE-RELIABILITY | P13, P16, P17, P21 | 1/2 |
| FUTURE-PLATFORM | P14, P15, P22 | 0/1 |
| FUTURE-DISTRIBUTION | P19, P20 | 0/1 |
| FUTURE-AI-ECOSYSTEM | P18, P23 | 0/1 |
