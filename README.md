...
```text
 1. `P6-S01` in-progress; realtime 100.0%; completion contribution 0.0%; updated 2026-09-26T02:00:21Z
...
- **Slice Completion:** **88.6%** (31 / 35 implemented). Remaining 4. 31 implemented, 1 in progress, 1 planned, 2 proposed.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
| `P6-S01` | Live community / private / custom node installation path over the P6 admission pipeline | Live community / private / custom node installation path over the P6 admission pipeline | 🔵 In progress | 100.0% | 0.0% | — | CP-06 DEC-0015 required self-hosted runner verification (completed, 15) | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `ab3ebf593208fc7d`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
