...
Checkpoint-weighted earned points / current-delivery points: 12775 / 14600. Denominator: programs P0–P11 only (146 active slices). Future programs are excluded. 3 slice(s) declare checkpoints. 125 implemented slice(s) have no checkpoint list and contribute 100 each. 18 slice(s) have no checkpoint model and contribute 0. A 0 from a missing model is not a measured fraction of that slice.
...
P5   realtime ██████████████░░░░░░  70.8%  completion  66.7%  12/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 70.8% | 66.7% | 12/18 | complete |
...
```text
 1. `P5-M07` in-progress; realtime 75.0%; completion contribution 0.0%; updated 2026-09-25T20:22:59Z
...
- **Realtime Delivery Progress:** **70.8%** `██████████████░░░░░░ 70.8%`
...
| `P5-M07` | Service-principal REST + UI management over the P5.7 programmatic lifecycle | Service-principal REST + UI management over the P5.7 programmatic lifecycle (create shown once, redacted list, revoke with tombstone) (split out of P5-M03) | 🔵 In progress | 75.0% | 0.0% | — | CP-04 PATCH /rest/service-principals/:id: ownership transfer (completed, 20) | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `d067ccfc59d9d459`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
