...
Checkpoint-weighted earned points / current-delivery points: 12685 / 14600. Denominator: programs P0–P11 only (146 active slices). Future programs are excluded. 2 slice(s) declare checkpoints. 125 implemented slice(s) have no checkpoint list and contribute 100 each. 19 slice(s) have no checkpoint model and contribute 0. A 0 from a missing model is not a measured fraction of that slice.
...
**126 / 146 slices implemented** in the same P0–P11 denominator. Only `implemented` increases this numerator. Verifying, blocked, in-progress, planned, proposed and deferred contribute 0. Superseded, retired and rejected stay out of the denominator.

| | |
| --- | ---: |
| Current-delivery slices | 146 |
| Implemented (completion numerator) | 126 |
...
P5   realtime █████████████░░░░░░░  65.8%  completion  61.1%  11/18  status complete
...
| P5 | Identity / Authentication / Authorization / Credentials (Security) | 65.8% | 61.1% | 11/18 | complete |
...
```text
 1. `P5-M09` in-progress; realtime 85.0%; completion contribution 0.0%; updated 2026-09-25T19:12:29Z
 2. `P5-M07` planned; realtime 0.0%; completion contribution 0.0%
 3. `P9-S01` planned; realtime 0.0%; completion contribution 0.0%
 4. `P3-S01` planned; realtime 0.0%; completion contribution 0.0%
 5. `P4-S01` planned; realtime 0.0%; completion contribution 0.0%
 6. `P6-S01` planned; realtime 0.0%; completion contribution 0.0%
 7. `P6-S02` planned; realtime 0.0%; completion contribution 0.0%
 8. `P2-S02` planned; realtime 0.0%; completion contribution 0.0%
 9. `P2-S03` planned; realtime 0.0%; completion contribution 0.0%
```

Latest completed slice: `P5-M08` (PR #304, merge `600a2145`).
...
Planned queue (planned ≠ authorized): `P5-M07` → `P9-S01` → `P3-S01` → `P4-S01` → `P6-S01` → `P6-S02` → `P2-S02` → `P2-S03`.
...
- **Realtime Delivery Progress:** **65.8%** `█████████████░░░░░░░ 65.8%`
- **Slice Completion:** **61.1%** (11 / 18 implemented). Remaining 7. 11 implemented, 1 in progress, 2 planned, 4 blocked.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
- **Checkpoint model:** 2 slice(s) declare checkpoints; 10 implemented slice(s) use the legacy 100 rule; 6 slice(s) have no checkpoint model and stay at 0.0%.
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `3a88aac5da57e97e`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
