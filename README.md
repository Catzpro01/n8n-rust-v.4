...
```text
 ...
 2. `P6-S02` in-progress; realtime 100.0%; completion contribution 0.0%; updated 2026-09-26T02:20:39Z
 3. `P7-S02` in-progress; realtime 0.0%; completion contribution 0.0%
...
Planned queue (planned ≠ authorized): `P7-S03` → `P7-S04` → `P7-S05` → `P7-S06` → `P7-S07` → `P7-S08` → `P2-S02` → `P2-S03`.
...
- **Slice Completion:** **0.0%** (0 / 8 implemented). Remaining 8. 0 implemented, 1 verifying, 1 in progress, 6 planned.
...
| `P7-S02` | Visibility & Dependency Graph | displayOptions visibility engine, parameter dependency graph, incremental recomputation of only affected fields, expression boundary (#223 §7-10, §42 P7.2) | 🔵 In progress | 0.0% | 0.0% | none declared | none declared | — |
...
- **Freshness:** generated by `npm run lego:ai` from register 2.4.0 (fingerprint `73b867fb9e732ee9`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
