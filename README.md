...
```text
 1. `P5-M09` planned; realtime 0.0%; completion contribution 0.0%
...
- **Slice Completion:** **61.1%** (11 / 18 implemented). Remaining 7. 11 implemented, 3 planned, 4 blocked.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `8a4c1ee5e9f9c008`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
