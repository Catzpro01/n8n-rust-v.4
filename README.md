...
```text
 ...
 2. `P2-S03` planned; realtime 0.0%; completion contribution 0.0%
```
...
Planned queue (planned ≠ authorized): `P2-S03`.
...
- **Slice Completion:** **94.1%** (32 / 34 implemented). Remaining 2. 32 implemented, 1 planned, 1 blocked.
- **Program status:** complete. Program status is not a percentage and is not 100% just because the word is complete.
...
- **Freshness:** generated by `npm run lego:ai` from register 2.3.0 (fingerprint `6d00fcadba6df29d`); `npm run lego:ai:check` fails when this section, the `.ai` pack or the register disagree.
