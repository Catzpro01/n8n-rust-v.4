...
| This record | `git log --oneline 8c299609..HEAD` | the reconciliation is the whole range, not one commit: read the list rather than a hash that the next commit invalidates |
