...
Generated: 2026-09-17T17:21:32.367Z  ·  Package: `packages/execution-engine`  ·  Language: JavaScript (Node.js ESM)
...
| E02 | sources are import-closed (no reference/ or n8n package imports) | ✅ PASS | 12 source files, all imports relative or node: builtins |
