...
Generated: 2026-09-17T19:42:05.570Z  ·  Package: `packages/execution-engine`  ·  Language: JavaScript (Node.js ESM)
...
| E02 | sources are import-closed (no reference/ or n8n package imports) | ✅ PASS | 19 source files, all imports relative or node: builtins |
