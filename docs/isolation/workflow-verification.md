...
Generated: 2026-09-17T20:26:05.512Z · reference n8n 2.9.4 (`b6dc2787c456`)
...
| G09 | BEFORE vs AFTER digest: BEHAVIOR CHANGE NONE | FAIL | /usr/local/bin/node /home/user/n8n-rust-v.4/tools/model-digest-runner.cjs --source reference --mode reference --out /tmp/lego-gate-Jh5kMS/before.json exited 1  TypeError [ERR_INVALID_ARG_VALUE]: The argument 'filename' m |
