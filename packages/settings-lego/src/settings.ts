/**
 * Settings & Localization LEGO — Reconstructed 1:1 from n8n v2.9.4
 * Source: reference/n8n/packages/frontend/editor-ui/src/stores/settings.store.ts
 *         plus Phase 4B i18n implementation
 */
...
export class SettingsLocalizationAdapter {
  ...
  public static setLanguage(lang: LanguageCode): void {
    ...
    NativeLocalizationService.setLocale(lang as SupportedLocale);
  }
