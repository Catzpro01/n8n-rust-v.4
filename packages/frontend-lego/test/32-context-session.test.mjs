...
test('the milestone register records P2.15 as complete on protected main and P2.16 as current without implementation', () => {
  ...
  assert.equal(MILESTONES.mainBaseline, '20ae0c1af9a7602d8f04b779902efa19df395b61', 'the baseline is the final protected-main commit (P2.27 Master Prompt section 3 corrected it from the superseded d65f9713, precedent Issue #76)');
...
test('the register keeps the strategic phases, the ladder and the merge protocol', () => {
  ...
  assert.equal(MILESTONES.mainBaseline, '20ae0c1af9a7602d8f04b779902efa19df395b61');
