...
test('the milestone register records P2.15 as complete on protected main and P2.16 as current without implementation', () => {
  ...
  assert.equal(MILESTONES.mainBaseline, '3478e8ccd5532db20e60c4dc6b858852e0e80434', 'the baseline is the final protected-main commit');
...
test('the register keeps the strategic phases, the ladder and the merge protocol', () => {
  ...
  assert.equal(MILESTONES.currentMilestone, 'P2.22', `currentMilestone follows the reconciliation ("${MILESTONES.currentMilestone}")`);
  ...
  assert.equal(MILESTONES.currentMilestone, 'P2.22');
  assert.equal(MILESTONES.previousCompletedMilestone, 'P2.21');
  assert.equal(MILESTONES.mainBaseline, '3478e8ccd5532db20e60c4dc6b858852e0e80434');
