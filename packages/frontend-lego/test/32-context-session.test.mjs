...
test('the milestone register records P2.15 as complete on protected main and P2.16 as current without implementation', () => {
  ...
  assert.equal(MILESTONES.mainBaseline, '37289ecec748e69d1f1d9cdbc501bafef60ee7f4', 'the baseline is the final protected-main commit');
...
test('the register keeps the strategic phases, the ladder and the merge protocol', () => {
  ...
  assert.equal(MILESTONES.mainBaseline, '37289ecec748e69d1f1d9cdbc501bafef60ee7f4');
