...
test('the quoted words are the words the pointed-at tree declares', { skip }, () => {
  ...
  assert.equal(lockRows().length, 21, 'P2.14 Memory, P2.15 Workspace, P2.16 Agent Machine and the P2.18 transport kernel are added to the seventeen protected-main rows');
