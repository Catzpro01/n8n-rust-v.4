...
test('the quoted words are the words the pointed-at tree declares', { skip }, () => {
  ...
  assert.equal(lockRows().length, 39, 'the thirty-two post-protected rows through P3 Slice A workflow.graph plus P3 Slice D execution.frontier (thirty-fourth) plus P3 Slice E execution.state-stream (thirty-fifth) plus P3 Slice H workflow.dna (thirty-sixth) plus P3 Slice J execution.ir (thirty-seventh) plus P3 Slice L compatibility.oracle (thirty-eighth) plus P3 Slice M execution.guard (thirty-ninth) are added to the seventeen protected-main rows');
