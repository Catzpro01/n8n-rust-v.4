...
test('the quoted words are the words the pointed-at tree declares', { skip }, () => {
  ...
  assert.equal(lockRows().length, 62, 'the thirty-two post-protected rows through P3 Slice A workflow.graph plus P3 Slice D execution.frontier (thirty-fourth) plus P3 Slice E execution.state-stream (thirty-fifth) plus P3 Slice H workflow.dna (thirty-sixth) plus P3 Slice J execution.ir (thirty-seventh) plus P3 Slice L compatibility.oracle (thirty-eighth) plus P3 Slice M execution.guard (thirty-ninth) plus P3 Slice K execution.optimizer (forty-first) are added to the seventeen protected-main rows — P6.1 adds node.registry@0.1.0; P6.2 adds registry.compiler@0.1.0; P6.3 adds package.transaction@0.1.0; P6.4 adds registry.closure@0.1.0; P6.5 adds node.resolution@0.1.0; P6.6 adds runtime.lease@0.1.0; P6.7 adds node.residency@0.1.0; P6.8 adds node.capability@0.1.0; P6.9 adds node.semantics@0.1.0; P6.10 adds node.lifecycle@0.1.0; P6.11 adds node.health@0.1.0; P6.12 adds node.supply-chain@0.1.0; P6.13 adds registry.incremental@0.1.0; P6.14 adds node.worker-convergence@0.1.0; P6.15 adds node.acceptance@0.1.0; P6.16 adds registry.integrity@0.1.0; P6.17 adds node.admission@0.1.0; P6.18 adds node.sbom@0.1.0; count-pins say 62');
