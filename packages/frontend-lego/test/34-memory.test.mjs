...
test('the quoted words are the words the pointed-at tree declares', { skip }, () => {
  ...
  assert.equal(lockRows().length, 26, 'P2.14 Memory, P2.15 Workspace, P2.16 Agent Machine, the P2.18 transport kernel, the P2.19 artifact/approval/audit foundations, the P2.20 MCP boundary declaration and the P2.21 runtime adapter seam are added to the seventeen protected-main rows');
