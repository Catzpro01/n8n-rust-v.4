...
test('the quoted words are the words the pointed-at tree declares', { skip }, () => {
  ...
  assert.equal(lockRows().length, 35, 'the thirty-two post-protected rows through P3 Slice A workflow.graph plus P3 Slice D execution.frontier (thirty-fourth) plus P3 Slice E execution.state-stream (thirty-fifth) are added to the seventeen protected-main rows');
