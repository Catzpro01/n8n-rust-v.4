...
export const VOCABULARIES = Object.freeze([
  ...
  Object.freeze({
    ...
    provenance: Object.freeze({
      ...
      read: 'keys',
      note: 'the AI set spells maturity with six words; the registry publishes eight for capabilities (`capabilityStatus`), so the two sets are quoted separately — `blocked` exists only here',
    }),
