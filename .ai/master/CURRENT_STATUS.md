...
| **Realtime Delivery Progress** | **87.3%** (P0–P11 checkpoint-weighted; future programs excluded; no checkpoint model contributes 0) |
...
- **P5-M07** (P5) — in-progress · realtime 40.0% · completion contribution 0.0% · current checkpoint — · latest completed CP-02 (completed) · updated 2026-09-25T20:22:46Z — P5-M07: service-principal REST surface mounted (create once, redacted list, revoke tombstone, transfer rotates the credential); DEC-0023 closes the member boundary
