...
- **P4-S01** (P4) — planned · realtime 0.0% · completion contribution 0.0% · current checkpoint — · latest completed — · updated 2026-09-25T21:30:25Z — P4-S01 started: checkpoint model installed (CP-01 34, CP-02 24, CP-03 20, CP-04 22 = 100). Weights derive from real scope: the predictive controller is the largest single item because it replaces the degenerate P4.8 clamp and adds the full telemetry surface, hysteresis and the stateful controller.
