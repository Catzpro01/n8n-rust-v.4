...
- **P4-S01** (P4) — planned · realtime 0.0% · completion contribution 0.0% · current checkpoint CP-01 (in-progress, 34) · latest completed — · updated 2026-09-25T21:30:38Z — P4-S01 moved to in-progress. Checkpoint model installed with four checkpoints whose weights derive from real scope (CP-01 34, CP-02 24, CP-03 20, CP-04 22 = 100): the predictive admission controller is the largest item because it replaces the degenerate P4.8 clamp and adds the full eight-signal telemetry surface, the stateful controller and hysteresis; the shadow path and the dedicated plane each carry contract-bound invariants; self-profiling is the smallest because it is a bounded, optional recorder.
