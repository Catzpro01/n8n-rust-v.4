...
| **Realtime Delivery Progress** | **87.4%** (P0–P11 checkpoint-weighted; future programs excluded; no checkpoint model contributes 0) |
...
- **P5-M07** (P5) — in-progress · realtime 55.0% · completion contribution 0.0% · current checkpoint — · latest completed CP-03 (completed) · updated 2026-09-25T20:22:48Z — P5-M07: service-principal REST surface mounted (create once, redacted list, revoke tombstone, transfer rotates the credential); DEC-0023 closes the member boundary
