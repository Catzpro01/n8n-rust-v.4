...
| **Realtime Delivery Progress** | **86.7%** (P0–P11 checkpoint-weighted; future programs excluded; no checkpoint model contributes 0) |
...
- **P5-M09** (P5) — in-progress · realtime 65.0% · completion contribution 0.0% · current checkpoint — · latest completed CP-03 (completed) · updated 2026-09-25T19:12:18Z — P5-M09: public /api/v1 credentials + users over the editor's backing stores
