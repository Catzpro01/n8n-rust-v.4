...
- **P5-M07** (P5) — in-progress · realtime 15.0% · completion contribution 0.0% · current checkpoint — · latest completed CP-01 (completed) · updated 2026-09-25T20:22:37Z — P5-M07: service-principal REST surface mounted (create once, redacted list, revoke tombstone, transfer rotates the credential); DEC-0023 closes the member boundary
