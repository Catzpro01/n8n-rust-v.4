...
- **P5-M07** (P5) — in-progress · realtime 0.0% · completion contribution 0.0% · current checkpoint CP-01 (in-progress, 15) · latest completed — · updated 2026-09-26T00:00:00Z — P5-M07: service-principal REST surface mounted (create once, redacted list, revoke tombstone, transfer rotates the credential); DEC-0023 closes the member boundary
