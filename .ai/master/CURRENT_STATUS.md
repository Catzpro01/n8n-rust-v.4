...
| **Realtime Delivery Progress** | **86.6%** (P0–P11 checkpoint-weighted; future programs excluded; no checkpoint model contributes 0) |
...
- **P5-M09** (P5) — in-progress · realtime 45.0% · completion contribution 0.0% · current checkpoint — · latest completed CP-02 (completed) · updated 2026-09-25T19:12:14Z — P5-M09: public /api/v1 credentials + users over the editor's backing stores
