...
| Field | Value |
|---|---|
| SESSION | Manager session 2026-09-25, part 5 (MANAGER-01) |
| MAIN | `84f30153` (merge of #305, governance DEC-0020; previous delivery #304 -> `600a2145`). Verify it against the remote |
